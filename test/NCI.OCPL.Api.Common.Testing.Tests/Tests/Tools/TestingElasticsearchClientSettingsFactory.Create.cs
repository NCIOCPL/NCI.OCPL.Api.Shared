...
{
  /// <summary>
  /// Tests for <see cref="TestingElasticsearchClientSettingsFactory"/>.
  /// </summary>
  public class TestingElasticsearchClientSettingsFactoryTest
  {
    /// <summary>
    ...
    {
      ElasticsearchClientSettings settings = TestingElasticsearchClientSettingsFactory.Create("{}", 200);
    ...
    {
      ElasticsearchClientSettings settings = TestingElasticsearchClientSettingsFactory.Create("{}", 200, _ => { });
    ...
    public void Create_WithConnection_ReturnsNonNullSettings()
    {
      ...
      ElasticsearchClientSettings settings = TestingElasticsearchClientSettingsFactory.Create(conn);
    ...
    {
      using var conn = new InMemoryConnection(Array.Empty<byte>(), 200);
      var client = new ElasticsearchClient(TestingElasticsearchClientSettingsFactory.Create(conn));
